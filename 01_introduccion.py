...
en multiples líneas
'''
#Imprime o despliega el texto en pantalla
...
nombre = input("¿Cómo te llamas? ") # ... y lo almacenamos en una variable
# la cual se podrá utilizar para desplegarla en pantalla de diferentes maneras:
